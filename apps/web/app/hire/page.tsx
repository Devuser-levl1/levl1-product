...
const CAPS: [string, string][] = [
  ...
  ['“Lev” — agentic assistant', 'A copilot that acts, not just answers. “Find five candidates for this role and add them to the pipeline.” “Draft outreach to my shortlist.” It proposes; you approve; it executes.'],
