...
function AcceptInner() {
  ...
  if (!token) return <AuthShell title="Invalid invite link"><div style={{ color: '#94A3B8', fontSize: 14 }}>This invite link is missing its token. Please use the link from your email.</div></AuthShell>
...
export default function HireAccept() {
  return <Suspense fallback={<AuthShell title="Loading…"><div /></AuthShell>}><AcceptInner /></Suspense>
}
