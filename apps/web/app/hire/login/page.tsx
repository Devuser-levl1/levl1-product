...
export default function HireLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/hire/auth/login", {
        method: "POST",
    ...
    >
      ...
      >
        <div style={{ maxWidth: 400, width: "100%" }}>
          ...
          >
            Looking for Levl1 Interviews?{" "}
            <Link
              href="/interviews/login"
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, rgba(124,58,237,0.25) 0%, rgba(124,58,237,0.15) 40%, rgba(124,58,237,0.75) 80%, rgba(124,58,237,0.95) 100%)",
          }}
        />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", marginTop: 2 }}>
                Founder, Vertex Talent Partners
              </div>
            </div>
          </div>
        </div>
